...
int init_module() {
    ...
    printk(KERN_ERR "If you want to talk to the device driver,\n");
    printk(KERN_ERR "you'll have to create a device file. \n");
    printk(KERN_ERR "We suggest you use:\n");
    printk(KERN_ERR "mknod %s c %d 0\n", DEVICE_FILE_NAME, MAJOR_NUM);
    printk(KERN_ERR "The device file name is important, because\n");
    printk(KERN_ERR "the ioctl program assumes that's the\n");
    printk(KERN_ERR "file you'll use.\n");
